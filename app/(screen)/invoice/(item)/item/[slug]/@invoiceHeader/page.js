...
const InvoiceHeader = async props => {
  ...
  return (
    <Suspense fallback={Loading}>
      <section className='rounded border border-stone-600 dark:border-slate-600 bg-stone-100 dark:bg-slate-900  px-6 py-4 flex justify-between items-center mb-5 gap-6'>
        <div className=''>
          <div className='flex justify-start items-center gap-5 flex-wrap'>
